...
<?php endif; ?>
    ...
    <form method="POST" action="<?php echo e(route('login')); ?>">
        ...
        <h1 style="margin-bottom: 32px; font-weight: 600; font-size: 18px;">asldfjsdlflsad</h1>
        <!-- Email Address -->
        <div>
...
<?php endif; ?><?php /**PATH C:\petergwapo\Taghoy\BSIT-3A-IPT2\Taghoy-Laravel-Homepage-User\resources\views/User/login.blade.php ENDPATH**/ ?>