...
<div class="cart-container">
    ...
    <div id="wishlist-container" class="wishlist-grid">
        ...
        <div class="product-card" 
            data-category="<?php echo e(strtolower($item->product->category->category_name)); ?>"
            data-wishlist-id="<?php echo e($item->id); ?>">
            ...
            <div class="product-info">
                ...
                <p>Stock: <?php echo e($item->product->stock); ?></p>
            </div>

            <div class="product-actions">
                <button class="btn-primary" onclick="addToCart(<?php echo e($item->product->id); ?>, <?php echo e($item->id); ?>)">
                    <i class="fa-solid fa-cart-plus"></i> Add to Cart
                </button>

                <button class="btn-delete" onclick="removeWishlistItem(<?php echo e($item->id); ?>)">
                    Remove
                </button>
            </div>
        </div>
...
<?php echo $__env->make('layouts.cart-layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\petergwapo\FashionStore\resources\views/Wishlist/wishlist.blade.php ENDPATH**/ ?>