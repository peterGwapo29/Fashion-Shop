<nav x-data="{ open: false }" class="sidebar">
    ...
    <ul class="sidebar-menu">
        ...
        <li>
            <a href="<?php echo e(route('orderAdmin')); ?>" class="<?php echo e(request()->routeIs('orderAdmin') ? 'active' : ''); ?>">
         ...
         <li>
            <a href="<?php echo e(route('category.index')); ?>" class="<?php echo e(request()->routeIs('category.index') ? 'active' : ''); ?>">
...
<?php /**PATH C:\petergwapo\FashionStore\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>