...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.primary-button','data' => ['class' => 'flex w-full text-center justify-center']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'flex w-full text-center justify-center']); ?>
...
<?php endif; ?>
    ...
    <div class="flex justify-center">
        <a href="<?php echo e(route('google_auth')); ?>"
    ...
    <div class="flex text-center justify-center items-center" style="margin-bottom: 16px;">
        Don't have an account?<span class="mx-2 text-blue-500 text-sm "> <a href="/register">Register</a></span>
    </div>

     <div class="flex text-center justify-center items-center" style="margin-bottom: 16px;">
        Back to <span class="mx-2 text-blue-500 text-sm "> <a href="/">home?</a></span>
    </div>
...
<?php endif; ?><?php /**PATH C:\petergwapo\FashionStore\resources\views/auth/login.blade.php ENDPATH**/ ?>